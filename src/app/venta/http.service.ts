...
export class HttpService {
  ...
  private setFilterSearch(form:any): void{
    this.filterSearch.cliente = form.filterCliente ?? this.filterSearch.cliente;
  ...
  */
  public search(formSearchFilter: any, pagination: Pagination): Observable<ResponseData> {
    ...
    params = params.append('filterCliente', this.filterSearch.cliente);
    ...
    return this.http.get<ResponseData>(`${path}/venta`, {
      headers: new HttpHeaders(environment.apiConfig.headers),
      reportProgress: true,
      params: params
    });
